...
void soundsphere::backend_init(void)
{
    ...
    s_window = SDL_CreateWindow(PROG_NAME, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
    if (s_window == nullptr)
    {
...
void soundsphere::backend_draw(soundsphere::DrawFn fn)
{
    ...
    while (!done)
    {
        ...
        SDL_SetRenderDrawColor(s_renderer, (Uint8)(clear_color.x * 255), (Uint8)(clear_color.y * 255), (Uint8)(clear_color.z * 255), (Uint8)(clear_color.w * 255));
...
soundsphere::Texture soundsphere::backend_load_image(const void* data, size_t size)
{
    ...
    SDL_Surface* surface = SDL_CreateRGBSurfaceFrom(img_data, img_width, img_height,
